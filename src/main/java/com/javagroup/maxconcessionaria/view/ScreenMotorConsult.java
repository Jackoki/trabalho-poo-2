...
public class ScreenMotorConsult extends javax.swing.JFrame {

    private final MotorcycleController motorcycleController;
    
    @Autowired
    public ScreenMotorConsult(MotorcycleController motorcycleController) {
    ...
    private void consultData() {
        ...
        motorcycleController.consultAll(tableModel);
    }
    ...
    private void initComponents() {
        ...
        TextTitle.setText("Consulta de Motos");
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                new ScreenMotorConsult(motorcycleController).setVisible(true);
            }
        });
    }
