...
public class ScreenCustomerScheduleCreate extends javax.swing.JFrame {
    
    private final ScheduleController scheduleController;
    MaskFormatter mfData;
    
    @Autowired
    public ScreenCustomerScheduleCreate(ScheduleController scheduleController) {
        try {
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                new ScreenCustomerScheduleCreate(scheduleController).setVisible(true);
            }
        });
    }
