...
public class ScreenCarConsultUnique extends javax.swing.JFrame {

    private final CarController carController;
    
    @Autowired
    public ScreenCarConsultUnique(CarController carController) {
        this.carController = carController;
        initComponents();
    }

    private void consultCar() throws IdDoesNotExistException {
        DefaultTableModel tableModel = (DefaultTableModel) tabelaCarros.getModel();
        carController.consultCar(jTextPane1.getText(), tableModel);
    }
    ...
    private void initComponents() {
        ...
        if (tabelaCarros.getColumnModel().getColumnCount() > 0) {
            ...
            tabelaCarros.getColumnModel().getColumn(6).setResizable(false);
        }

        TextTitle.setFont(new java.awt.Font("Lucida Sans", 1, 18)); // NOI18N
        TextTitle.setText("Consulta de Carro");
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                new ScreenCarConsultUnique(carController).setVisible(true);
            }
        });
    }
