...
public class ScreenCustomerConfirm extends javax.swing.JFrame {

    private final CustomerController customerController;
    private static ScreenCustomerConfirm insUnic;
    private String carPlate;
    private boolean confirmCarBuy;
    
    //Singleton
    public static ScreenCustomerConfirm ScreenCustomerConfirm(CustomerController customerController, String carPlate){
        if(insUnic == null){
            insUnic = new ScreenCustomerConfirm(customerController, carPlate);
        }
        return insUnic;
    }
    
    @Autowired
    public ScreenCustomerConfirm(CustomerController customerController, String carPlate) {
    ...
    public void confirmBuy(Boolean loginSucess, String plate, String userName){
        if(loginSucess == true){
            ...
            carController.buyCar(plate, userName);
            this.dispose();
        }
    }
    ...
    private void ConfirmButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ConfirmButtonActionPerformed
        confirmCarBuy = customerController.loginCustomer(userField.getText(), passwordField.getText());
        confirmBuy(confirmCarBuy, carPlate, userField.getText());
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                new ScreenCustomerConfirm(customerController, carPlate).setVisible(true);
            }
        });
    }
