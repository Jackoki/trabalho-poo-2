...
public class ScreenScheduleConsult extends javax.swing.JFrame {

    private final ScheduleController scheduleController;
    
    @Autowired
    public ScreenScheduleConsult(ScheduleController scheduleController) {
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                new ScreenScheduleConsult(scheduleController).setVisible(true);
            }
        });
    }
