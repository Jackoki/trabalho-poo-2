...
public class ScreenCustomerVehiclesConsult extends javax.swing.JFrame {
    private final CarController carController;
    private String userName;
    
    @Autowired
    public ScreenCustomerVehiclesConsult(CarController carController, String userName) {
    ...
    public void consultData() {
        ...
        carController.consultAllByUser(tableModel, userName);
    }
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                new ScreenCustomerVehiclesConsult(carController, userName).setVisible(true);
            }
        });
    }
