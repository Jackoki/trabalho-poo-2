...
public class ScreenScheduleCreate extends javax.swing.JFrame {
    
    private final ScheduleController scheduleController;
    MaskFormatter mfData;
    
    @Autowired
    public ScreenScheduleCreate(ScheduleController scheduleController) {
        try {
    ...
    private void initComponents() {
        ...
        TextTitle.setText("Registre a Agenda");
        ...
        ButtonRegister.setText("Registrar Agenda");
    ...
    private void ButtonRegisterActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ButtonRegisterActionPerformed
        try {
            ...
            scheduleController.save(date, userName);
        }
    ...
    private void ReturnButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ReturnButtonActionPerformed
        ScreenEmployeeScheduleMenu screenEmployeeScheduleMenu = ScreenEmployeeScheduleMenu.geraScreenEmployeeScheduleMenu();
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                new ScreenScheduleCreate(scheduleController).setVisible(true);
            }
        });
    }
