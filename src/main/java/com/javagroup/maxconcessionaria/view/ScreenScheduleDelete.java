...
public class ScreenScheduleDelete extends javax.swing.JFrame {
    
    private final ScheduleController scheduleController;
    MaskFormatter mfData;
    
    @Autowired
    public ScreenScheduleDelete(ScheduleController scheduleController) {
        try {
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                new ScreenScheduleDelete(scheduleController).setVisible(true);
            }
        });
    }
